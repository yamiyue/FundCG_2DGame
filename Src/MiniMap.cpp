...
void MiniMap::DimensionTransformation(GLfloat source[],GLfloat target[][4])
{
...
void MiniMap::Begin(int programIndex)
{
	shaderProgram = shaderPrograms[programIndex];
	shaderProgram->bind();
	vao.bind();
}
void MiniMap::Paint(GLfloat* ProjectionMatrix, GLfloat* ModelViewMatrix)
{
	GLfloat P[4][4];
	GLfloat MV[4][4];
...
void MiniMap::InitVAO()
{
	vao.create();
	vao.bind();
}
void MiniMap::InitVBO()
{
...
void MiniMap::InitShader(QString vertexShaderPath,QString fragmentShaderPath)
{
	// Create Shader
