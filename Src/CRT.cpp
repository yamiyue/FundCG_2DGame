...
void CRT::DimensionTransformation(GLfloat source[],GLfloat target[][4])
{
...
void CRT::Begin(int programIndex)
{
...
void CRT::Paint(GLfloat* ProjectionMatrix, GLfloat* ModelViewMatrix)
{
	GLfloat P[4][4];
	GLfloat MV[4][4];
...
void CRT::Init()
{
	InitShader("./Shader/post_CRT.vs", "./Shader/post_CRT.fs");	
	InitVAO();
	InitVBO();
}
...
void CRT::InitShader(QString vertexShaderPath,QString fragmentShaderPath)
{
	// Create Shader
